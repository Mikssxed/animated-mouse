...
bodyEl.addEventListener("mousemove", function (e) {
  ...
  count++;
  //changing colors: 0.90196, 0.01961, 0.94510 to 0.88235, 0.03529, 0.13725, 1.0
  count > 25 &&
    ((colorArr = [
      randomIntFromInterval(0.88325, 0.90196),
      randomIntFromInterval(0.01961, 0.03529),
      randomIntFromInterval(0.13725, 0.9451),
    ]),
    (count = 0));
